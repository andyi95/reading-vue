...
async function login() {
    ...
    const { authResponse } = await new Promise(function (resolve, reject){
            ...
            }, {scope: 'read_insights,publish_video,pages_manage_instant_articles,pages_show_list,' +
                    'business_management,pages_messaging,pages_read_engagement,read_insights,' +
                    'pages_manage_metadata,pages_read_user_content,pages_manage_ads,' +
                    'pages_manage_posts,pages_manage_engagement,public_profile,read_insights'})
    });
